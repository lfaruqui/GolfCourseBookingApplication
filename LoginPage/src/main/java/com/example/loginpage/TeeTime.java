...
public class TeeTime {
    ...
    public TeeTime(String date, String time, String member_name, int mem_present, String mem_cart,
    ...
    public int getMem_present() {
        return mem_present;
    }

    public void setMem_present(int mem_present) {
        this.mem_present = mem_present;
    }
