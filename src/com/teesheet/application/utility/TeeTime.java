...
public class TeeTime {
    ...
    public TeeTime(String d, String t){
        date = d;
        time = t;
        blocked =false;
    }

    public TeeTime(String date, String time, boolean blocked, String member_name, String player1_name,
                   String player2_name, String player3_name, String player4_name, String caddie) {
        this.date = date;
        this.time = time;
    ...
    public TeeTime(String date, String time, boolean blocked, String member_name, boolean mem_present, String mem_cart,
    ...
    public String toString(){
        return "Member_Name=\"" + member_name + "\",mem_present=\"" + mem_present + "\",mem_cart=\"" + mem_cart + "\"," +
                ...
                "Caddie=\"" + caddie + "\",Creator=\"" + creator + "\" WHERE _date_=\"" + date + "\" AND clock=\"" + time + "\"";
    ...
    public String toJSONString(){
        return "Member_Name:\"" + member_name + "\",mem_present:\"" + mem_present + "\",mem_cart:\"" + mem_cart + "\"," +
                ...
                "Player3_Name:\"" + player3_name + "\", p3_cart:\"" + p3_cart + "\",p3_reference:\"" + p3_reference + "\","+
                "Player4_Name:\"" + player4_name + "\", p4_cart:\"" + p4_cart + "\",p4_reference:\"" + p4_reference + "\","+
                "Caddie:\"" + caddie + "\",Creator:\"" + creator + "\", _date_:\"" + date + "\",clock:\"" + time + "\"";
